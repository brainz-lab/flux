...
class PlatformClient
  ...
  class << self
    ...
    def validate_key_uncached(key)
      ...
      request["User-Agent"] = "flux/#{Rails.application.config.version rescue '1.0'}"
    ...
    def find_or_create_project(result, api_key)
      ...
      if project
        ...
        if project.api_key != api_key
          ...
          Rails.logger.info "[PlatformClient] Synced regenerated key for project #{project.slug}"
        end
        return project
      end
